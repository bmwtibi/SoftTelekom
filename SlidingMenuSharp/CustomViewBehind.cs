...
namespace SlidingMenuSharp
{
    public sealed class CustomViewBehind : ViewGroup
    {
        ...
        public MenuMode Mode
        {
            ...
            set
            {
                if (value == MenuMode.Left)
                {
                    if (_content != null) _content.Visibility = ViewStates.Visible;
                    if (_secondaryContent != null) _secondaryContent.Visibility = ViewStates.Invisible;
                }
                else if (value == MenuMode.Right)
                {
                    if (_content != null) _content.Visibility = ViewStates.Invisible;
                    if (_secondaryContent != null) _secondaryContent.Visibility = ViewStates.Visible;
                }
                _mode = value;
            }
        }
